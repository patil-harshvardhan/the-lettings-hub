...
const Intro = () => {
  return (
    <div className="font-[family-name:var(--font-geist-mono)] flex flex-col items-center sm:items-start text-center sm:text-left">
      ...
      <p className="mt-3 text-base sm:text-lg leading-relaxed max-w-2xl">
      ...
      <div className="flex gap-4 items-center flex-col sm:flex-row mt-8">
        <a
          className="rounded-full border border-transparent transition-colors flex items-center justify-center bg-foreground text-background gap-2 hover:bg-[#383838] dark:hover:bg-[#ccc] text-sm sm:text-base h-10 sm:h-12 px-4 sm:px-5 shadow-lg hover:shadow-xl"
          href="/likes"
        >
          What I Like
        </a>
        <a
          className="rounded-full border border-black/[.08] dark:border-white/[.145] transition-colors flex items-center justify-center hover:bg-[#f2f2f2] dark:hover:bg-[#1a1a1a] hover:border-transparent text-sm sm:text-base h-10 sm:h-12 px-4 sm:px-5 shadow-lg hover:shadow-xl"
          href="/achievements"
        >
          My Achievements
        </a>
